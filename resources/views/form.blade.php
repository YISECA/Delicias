  ...
  <form method="POST" action="insertar" id="form_gen" enctype="multipart/form-data">
    ...
    <div class="row">
         ...
         <div class="col-md-4">
          ...
          <input required type="text" class="form-control" id="primer_nombre" name="primer_nombre" onkeyup="javascript:this.value=this.value.toUpperCase();" ><br>
         </div>
    </div>
<!-- 2 fila-->
        <div class="row">
         <div class="col-md-4">
           ...
           <input type="text" class="form-control" id="segundo_nombre" name="segundo_nombre"  onkeyup="javascript:this.value=this.value.toUpperCase();">
         </div>
         <div class="col-md-4">
...
<!-- 3 fila-->
    ...
    <!-- 4 fila-->
        <div class="row">
         ...
         <div class="col-md-4">
              <input type="hidden" name="fecha_caminata" id="fecha_caminata" value="2017-11-12"><br>
         </div>
    </div>
